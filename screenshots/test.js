...
(async () => {
  ...
  await page.goto('https://8080-ecebbfeeddcdfeacdddacabbeddaccfebecada.ide.exam.ly');
  ...
  await page1.goto('https://8081-ecebbfeeddcdfeacdddacabbeddaccfebecada.ide.exam.ly');
