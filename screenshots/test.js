...
(async () => {
  ...
  await page.goto('https://8080-ecebbfeeddcdfeacdddacabbedfaecacdbabcf.ide.exam.ly');
  ...
  await page1.goto('https://8081-ecebbfeeddcdfeacdddacabbedfaecacdbabcf.ide.exam.ly');
